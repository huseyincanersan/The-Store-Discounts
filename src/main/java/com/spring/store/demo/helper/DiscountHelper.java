...
public class DiscountHelper {
    ...
    private static final double GOLDCARD_DISCOUNT_PERCENTAGE = 0.30;
    private static final double SILVERCARD_DISCOUNT_PERCENTAGE = 0.20;
    ...
    public BigDecimal getUserDiscount(User user) {
        ...
        switch (type) {
            case GOLDCARD:
                discount = new BigDecimal(GOLDCARD_DISCOUNT_PERCENTAGE).setScale(2, RoundingMode.HALF_EVEN);
                break;
                
            case SILVERCARD:
                discount = new BigDecimal(SILVERCARD_DISCOUNT_PERCENTAGE).setScale(2, RoundingMode.HALF_EVEN);
                break;
