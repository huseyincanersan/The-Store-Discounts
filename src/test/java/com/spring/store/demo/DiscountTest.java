...
public class DiscountTest {
	...
	public void testCalculateTotal_PhonesOnly() {
		...
		BigDecimal total = helper.calculateTotalPerType(items, ItemType.PHONE);
	...
	@Test
	public void testGetUserSpecificDiscount_goldcard() {
		User user = new User(UserType.GOLDCARD, LocalDate.now());
		DiscountHelper helper = new DiscountHelper();
		BigDecimal discount = helper.getUserDiscount(user);
	...
	@Test
	public void testGetUserSpecificDiscount_silvercard() {
		User user = new User(UserType.SILVERCARD, LocalDate.now());
		DiscountHelper helper = new DiscountHelper();
		BigDecimal discount = helper.getUserDiscount(user);
	...
	public void testDiscountServiceCalculate() {
		List<Item> items = new ArrayList<Item>();
		items.add(new Item(ItemType.PHONE, new BigDecimal(50.0)));
		items.add(new Item(ItemType.TECHNOLOGY, new BigDecimal(200.0)));
		items.add(new Item(ItemType.PHONE, new BigDecimal(10.0)));
